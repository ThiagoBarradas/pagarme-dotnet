...
namespace PagarMe
{
    ...
    /// PagarMe Api Client
    /// </summary>
    public class PagarMeApiClient : IPagarMeApiClient
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="configuration">PagarMe Api configuration</param>
        public PagarMeApiClient(Configuration configuration)
        {
